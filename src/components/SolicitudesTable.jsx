...
const SolicitudesTable = ({
  ...
  const [_observacion, setObservacion] = useState("");
  const [_overrideCantidad, setOverrideCantidad] = useState("");
  ...
  return (
    <div className="card shadow-sm mt-3">
      <div className="card-header bg-white d-flex justify-content-between align-items-center">
        <h6 className="mb-0">
          {" "}
          {numericRole === 3 ? "Mis Solicitudes" : "Solicitudes de Vendedores"}
        </h6>
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                filtered
                  .filter(
                    (item) =>
                      String(item.codigo_vendedor) ===
                      String(u?.codigo_vendedor),
                  )
                  .map((s, idx) => (
                    <tr key={s.id ?? idx}>
                      <td>{s.id ?? idx + 1}</td>
                      ...
                      {u?.rol !== 3 && (
                        <td>
                          {s.estado_aprobacion ? null : (
                            <button
                              className="d-flex justify-content-center align-items-center w-50 h-50 rounded-circle btn btn-primary "
                              onClick={() => openModal(s)}
                            >
                    ...
                    <div className="row g-3">
                      <div className="col-12 col-md-6">
                        <ul className="list-group list-group-flush">
                          <li className="list-group-item px-0 d-flex justify-content-between">
                            <span className="text-muted">N° Solicitud</span>
                          ...
                          <li className="list-group-item px-0 d-flex justify-content-between">
                            ...
                            <span className="fw-semibold">{`${selected.codigo_vendedor} - ${vendedores?.filter((v) => String(v.co_ven) === String(selected.codigo_vendedor))?.map((v) => v.ven_des || "Vendedor no encontrado")}`}</span>
                          </li>
                          ...
                          <li className="list-group-item px-0 d-flex justify-content-between">
                            ...
                            <span className="fw-semibold">
                              {Number(selected.cantidad_solicitada)}
                            </span>
                          </li>
                        </ul>
                      </div>
                      <div className="col-12 col-md-6">
                        <ul className="list-group list-group-flush">
                          <li className="list-group-item px-0 d-flex justify-content-between">
                            ...
                            >
                              {formatearFecha(selected.fecha_solicitud)}
                            </span>
                          </li>
                      ...
                      <div className="col-12 col-md-6">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              cantidad_aprobada: e.target.value,
                            })
                          }
                        />
                        <small className="text-muted">
                          Puedes ajustar la cantidad aprobada diferente a la
                          solicitada.
                        </small>
                      </div>
                      ...
                      <div className="col-12">
                        ...
                        <textarea
                          ...
                          className="form-control"
                          rows={3}
                          placeholder="Agregue una observación (opcional)"
