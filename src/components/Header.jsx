...
const Header = () => {
  ...
  return (
    <header
      ...
      style={{
        background:
          "linear-gradient(90deg,rgba(13, 13, 14, 0) 0%, rgb(231, 233, 235) 100%)",
      ...
      <div className="container d-flex justify-content-between align-items-center gap-3">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <div className="position-relative notification-container">
            ...
            {showNotifications && (
              <div
                className="notification-dropdown position-absolute end-0 mt-2"
                    ...
                    <div className="list-group list-group-flush list-body">
                      ...
                      {notifications.map((n) => (
                        <button
                          key={n.id}
                          type="button"
                          className="list-group-item list-group-item-action d-flex align-items-start py-2"
                          onClick={() => markRead(n.id)}
                        >
                          <div
                            className={`bg-${n.color} rounded-circle d-flex align-items-center justify-content-center me-3`}
                            style={{ width: "30px", height: "30px" }}
                          >
                            <i
                              className={`bi ${n.icon} text-white`}
