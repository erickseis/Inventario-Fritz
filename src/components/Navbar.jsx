...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark shadow-sm" style={{background: 'linear-gradient(90deg, #0d6efd 0%, #6ea8fe 100%)', position:'sticky', top:0, zIndex: 1080}}>
