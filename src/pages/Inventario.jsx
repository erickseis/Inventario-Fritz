...
const fetchRequerimientos =async()=>{
  ...
  const formatearFecha = (fecha) => {
    ...
    try {
      ...
      if (isNaN(date.getTime())) return fecha; // Si no es una fecha válida, devuelve el valor original
  ...
  return (
    <div className="container py-3">
      <div className="card border-0 shadow-sm overflow-hidden">
        <div className="p-4" style={{background: 'linear-gradient(90deg, #198754 0%, #63c39b 100%)'}}>
          <h5 className="mb-0 text-white d-flex align-items-center gap-2">
            <i className="bi bi-box-seam"></i>
            Inventario
          </h5>
          <small className="text-white-50">Gestione requerimientos y consulte solicitudes registradas</small>
        </div>
        ...
        <div className="card-body">
          <div className="row g-4">
            <div className="col-12">
              ...
              <SolicitudesTable data={solicitudes} formatearFecha={formatearFecha} fetchRequerimientos={fetchRequerimientos} />
            </div>
            ...
            {numericRole === 3 && (
              <div className="col-12">
                ...
                <div className="p-3 border rounded-3">
                  <SolicitudRequerimientoForm fetchRequerimientos={fetchRequerimientos}  />
                </div>
              </div>
            )}
          </div>
